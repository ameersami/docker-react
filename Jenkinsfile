      ...
      steps {
        script {
          ...
          withCredentials([usernamePassword(credentialsId: 'Github', usernameVariable: 'GITHUB_USERNAME', passwordVariable: 'GITHUB_PASSWORD')]) {
              def repoURL = """
                https://portainer.turkiyeoku.com/api/endpoints/1/docker/build?t=webapp:v1&remote=https://$GITHUB_USERNAME:$GITHUB_PASSWORD@github.com/$GITHUB_USERNAME/docker-react.git&dockerfile=Dockerfile&nocache=true
              """
